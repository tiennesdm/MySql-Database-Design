...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2019 at 03:16 PM
...
--
-- Triggers `studentlicense`
--
DELIMITER $$
CREATE TRIGGER `studentLicense_BEFORE_INSERT` BEFORE INSERT ON `studentlicense` FOR EACH ROW BEGIN
...
CREATE TABLE `videoinfo` (
  ...
  `playerPath` varchar(45) NOT NULL,
  `videoLength` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
